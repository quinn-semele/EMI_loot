...
public record TextKey(int index, List<String> args){
    ...
    static{
        ...
        mapBuilder(5,"emi_loot.function.randomly_enchanted_book",(key)-> getBasicText(5), Identifier.of(EMILoot.MOD_ID,"textures/gui/random_book.png"));
        mapBuilder(6,"emi_loot.function.randomly_enchanted_item",(key)-> getBasicText(6), Identifier.of(EMILoot.MOD_ID,"textures/gui/random_item.png"));
        ...
        mapBuilder(9,"emi_loot.function.smelt",(key)-> getBasicText(9), Identifier.of(EMILoot.MOD_ID,"textures/gui/smelt.png"));
        ...
        mapBuilder(38,"emi_loot.condition.alternates",(key)-> getOneArgText(38, key), Identifier.of(EMILoot.MOD_ID,"textures/gui/or.png"));
        mapBuilder(39,"emi_loot.condition.alternates_2",(key)-> getTwoArgText(39, key), Identifier.of(EMILoot.MOD_ID,"textures/gui/or.png"));
        mapBuilder(40,"emi_loot.condition.alternates_3",(key)-> getAlternates3Text(40, key), Identifier.of(EMILoot.MOD_ID,"textures/gui/or.png"));
        ...
        mapBuilder(130,"emi_loot.function.ominous_banner",(key)-> getBasicText(130), Identifier.of(EMILoot.MOD_ID,"textures/gui/ominous.png"));
        //No conditions
